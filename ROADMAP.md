...
### Beyond the Bible (same architecture)
- **Classical philology** — Iliad/Odyssey across manuscript families
- **Qur'anic studies** — the seven canonical recensions (qirāʾāt) in parallel
- **Buddhist textual studies** — parallel Pāli / Sanskrit / Chinese / Tibetan sutra editions
- **Any multi-witness historical text** — legal codes, chronicles, philosophical treatises
...
**Beyond the canonical Bible (stretch):**
- **Qur'an** — multiple recensions (Hafs / Warsh / Qalun etc.) + historical Arabic manuscripts + translations
- **Homer** — parallel manuscript traditions of the Iliad and Odyssey
- **Buddhist sutras** — Pāli / Chinese / Tibetan / Sanskrit parallels
- **Zoroastrian Avesta** — Avestan + Pahlavi translations
- **Any corpus with multiple witnesses and variants worth annotating**
